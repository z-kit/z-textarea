...
test('CSS component - border', (t) => {
  ...
  return Nightmare()
    .goto('http://localhost:6006/iframe.html?id=css-component--default')
    .wait('.z-textarea')
    .evaluate(() => getComputedStyle(document.querySelector('.z-textarea > textarea')).borderBottom)
    .end()
    .then(actual => t.deepEqual(expected, actual, msg));
});
...
test('CSS component - label', (t) => {
  ...
  const expected = '16px';
  return Nightmare()
    .goto('http://localhost:6006/iframe.html?id=css-component--label')
    .wait('.z-textarea')
...
test('CSS component - success', (t) => {
  ...
  return Nightmare()
    .goto('http://localhost:6006/iframe.html?id=css-component--colors')
    .wait('.z-textarea')
...
test('CSS component - disabled textarea', (t) => {
  ...
  const expected = 0;
  return Nightmare()
    .goto('http://localhost:6006/iframe.html?id=css-component--disabled-textarea')
    .wait('.z-textarea')
    .evaluate(() => {
...
test('CSS component - dark', (t) => {
  ...
  return Nightmare()
    .goto('http://localhost:6006/iframe.html?id=css-component--dark')
    .wait('.z-textarea')
